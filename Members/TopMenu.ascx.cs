...
public partial class Members_TopMenu : System.Web.UI.UserControl
{
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        oSingleton.ProfileId = 0;
        oSingleton.Username = string.Empty;
        oSingleton.PasswordHash = string.Empty;
        oSingleton.Locked = 0;
        oSingleton.Blocked = 0;
        oSingleton.Roles = string.Empty;
